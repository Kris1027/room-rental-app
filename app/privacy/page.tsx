		...
		<main className="flex-1 w-full max-w-7xl mx-auto p-1 md:p-4">
			...
			<section className="mb-8">
				...
				<p className="mb-4">
					...
					create an account, list a room, or communicate with us. This may
			...
			<section className="mb-8">
				...
				<p className="mb-4">
					...
					your browsing activities and to personalize your experience on our
					site.
				</p>
			</section>
