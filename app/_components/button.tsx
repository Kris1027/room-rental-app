...
export const Button: React.FC<ButtonProps> = ({
   ...
   const baseStyle =
      'flex items-center justify-center gap-1 rounded-lg transition-all duration-300 ease-in-out font-semibold shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-opacity-50';
