   ...
   return (
      <div className='container mx-auto px-4 py-8'>
         ...
         <section className='mb-8'>
            ...
            <p className='mb-4'>
               By accessing or using the Room Rental App, you agree to be bound
         ...
         <section className='mb-8'>
            ...
            <p className='mb-4'>
               You agree to use the Room Rental App only for purposes that are
         ...
         <section className='mb-8'>
            ...
            <p className='mb-4'>
               To use certain features of the Room Rental App, you may be
         ...
         <section className='mb-8'>
            ...
            <p className='mb-4'>
               ...
               Room Rental App. We reserve the right to remove any content that
         ...
         <section className='mb-8'>
            ...
            <p className='mb-4'>
               ...
               always post the most current version on our website. Your
               continued use of the Room Rental App after changes constitutes
